        ...
        <form action="my_book.php" method="POST">
            <div class="container background-color border">
                <div class="row">
                  <div class="col">
                    <div class="col-lg-6">
                        <img src="<?php if(isset($_POST['img'])){echo $_POST['img'];}else{echo 'https://london.bridestory.com/images/c_fill,dpr_2.0,f_auto,fl_progressive,pg_1,q_80,w_680/v1/assets/grand_ballroom_classroom_xk4cbx/novotel-tangerang_grand-ballroom1437552529_2.webp';}?>" alt="" class="gambar-build" style="width: 500px">
                    </div>
                  </div>
                  <!-- Name -->
                  <div class="col">
